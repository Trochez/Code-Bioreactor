...
NIL_THREADS_TABLE_ENTRY(NULL, ThreadSetup, NULL, waThreadSetup, sizeof(waThreadSetup))      //server connection, control the devices plugged, working mode and possible encountered error to send messages
